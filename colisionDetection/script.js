...
class Explosion {
    ...
    draw() {
        ...
        ctx.drawImage(this.image, this.frame * this.srcWidth, 0, this.srcWidth, this.srcHeight, 0 - this.destWidth / 2, 0 - this.destHeight / 2, this.destWidth, this.destHeight);
        ctx.restore();
    }
}
const explosions = [];
